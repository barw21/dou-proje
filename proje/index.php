...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        body { margin:0; display:flex; font-family:'Segoe UI', sans-serif; background:#050505; color:#fff; min-height:100vh; }
        
        /* Sidebar */
        .sidebar { width:260px; background:#0a0a0a; padding:30px 15px; border-right:1px solid #c0392b; flex-shrink: 0; display: flex; flex-direction: column; }
        ...
        /* Main İçerik */
        .main { flex:1; padding:50px; display:flex; flex-direction:column; min-height: 100vh; }
        .kart { background:#0d0d0d; padding:20px; border-radius:8px; border:1px solid #1a1a1a; margin-bottom:20px; transition:0.3s; }
        ...
        /* Banner - Sayfa sonunda sabit */
        .banner { background:#c0392b; color:#fff; padding:20px; text-align:center; margin-top:auto; border-radius:8px; font-weight:bold; width:100%; }
    </style>
</head>
<body>
    ...
    <div class="sidebar">
        ...
        <a href="?sayfa=araclar">ARAÇLAR</a>
        ...
        <?php elseif(isset($_SESSION['uye'])): ?>
            <a href="hesap.php" style="color:#fff;">HESABIM (<?php echo $_SESSION['uye']; ?>)</a>
            <a href="?cikis=1" style="color:#c0392b;">ÇIKIŞ YAP</a>
        <?php else: ?>
    ...
    <div class="main">
        ...
        <?php elseif(isset($_GET['sayfa']) && $_GET['sayfa'] == 'iletisim'): ?>
            <div class="kart">
                ...
                <iframe src="https://maps.google.com/5" width="100%" height="250" style="border:0; border-radius:8px;" allowfullscreen="" loading="lazy"></iframe>
            </div>
